...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = 'Flappy Bird/Sprites/yellowbird-midflap.png'
BACKGROUND = 'Flappy Bird/Sprites/background-night.png'
PIPE = 'Flappy Bird/Sprites/pipe-green.png'
...
if __name__ == "__main__":
    ...
    # Game sounds
    GAME_SOUNDS['die'] = pygame.mixer.Sound('Flappy Bird/Sounds/die.wav')
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('Flappy Bird/Sounds/hit.wav')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('Flappy Bird/Sounds/point.wav')
    GAME_SOUNDS['swoosh'] = pygame.mixer.Sound('Flappy Bird/Sounds/swoosh.wav')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('Flappy Bird/Sounds/wing.wav')

    GAME_SPRITES['background'] = pygame.image.load(BACKGROUND).convert()
    GAME_SPRITES['player'] = pygame.image.load(PLAYER).convert_alpha()

    while True:
        welcomeScreen() # Shows welcome screento untill button pressed
